...
const MainComponents = () => {
  return (
    <main className="flex w-[60%] h-full min-h-screen flex-col border-l-[0.5px] border-r border-gray-600">
          ...
          <div className="border-t-[0.5px] px-4 border-b-[0.5px] flex items-stretch py-4 space-x-2 border-gray-600  relative">
            ...
            <div className="flex flex-col w-full h-full">
              ...
              <div className="w-full justify-between items-center flex">
                ...
                <button className=' rounded-full  bg-cyan-600 px-4 py-2 w-full text-lg text-center hover:opacity-70 transition duration-100 font-bold'>Share
    </button>
                </div>
